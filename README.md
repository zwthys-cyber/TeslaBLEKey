...
- Tesla 风格主页媒体卡在播放或暂停时保留，支持上一首、播放/暂停和下一首；根据车机返回的歌名和歌手自动匹配 Apple 公共音乐目录封面，断网或无匹配时优雅回退
- 主页与车辆详情均支持下拉刷新本地车机状态
...
- Tesla 本地蓝牙媒体协议不返回封面或循环模式，也不提供循环控制指令；封面来自免登录的 Apple 公共目录匹配，可能因同名歌曲出现偏差，单曲循环无法通过本地 BLE 控制。
