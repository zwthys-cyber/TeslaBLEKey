...
| --- | --- | --- | --- |
| 001 | Build a continuous vehicle stage | HIGH | TODO |
| 002 | Make every vehicle action causal | HIGH | TODO |
| 003 | Recompose the control surface | MEDIUM | TODO |
| 004 | Centralize the motion language | MEDIUM | TODO |
